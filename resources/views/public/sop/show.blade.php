    ...
    <nav class="flex mb-6" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            <li class="inline-flex items-center">
                <a href="{{ route('sop.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div class="flex items-start justify-between mb-4">
            ...
            <div class="flex flex-col space-y-2 ml-6">
                @if($sop->file_path)
                    <a href="{{ route('sop.download', $sop->nomor_sop) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-center">
                ...
                <button onclick="shareSOP()" class="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                @foreach($relatedSops as $relatedSop)
                    <a href="{{ route('sop.show', $relatedSop->nomor_sop) }}" class="block p-4 border border-gray-200 rounded-lg hover:border-blue-300 hover:shadow-md transition-all">
