    ...
    public function run(): void
    {
        ...
        $sampleSops = [
            [
                ...
                'versi' => 1,
                'created_by' => $users->where('bidang_bagian', 'Bidang Pelayanan')->first()->id,
            ],
            [
                ...
                'versi' => 2,
                'created_by' => $users->where('bidang_bagian', 'Bidang Pengendalian')->first()->id,
            ],
            [
            ...
            [
                ...
                'versi' => 1,
                'created_by' => $users->where('bidang_bagian', 'Bagian Tata Usaha')->first()->id,
            ],
        ];
